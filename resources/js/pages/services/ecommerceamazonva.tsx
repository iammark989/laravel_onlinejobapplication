          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="mt-5 text-4xl md:text-5xl font-bold text-slate-800 leading-tight">
                Dedicated Support for Growing Online Stores
              </h1>
              ...
              <p className="mt-6 text-lg text-slate-600 leading-relaxed">
                ...
                operations so you can scale confidently.
              </p>
              ...
              />
                ...
                <div className="bg-blue-50 border-l-4 border-slate-500 p-6 rounded-r-xl">
                    <p className="text-xl font-semibold text-slate-800">
                        Focus on growing sales while we help manage the day-to-day operations.
                    </p>
                </div>      
        </div>
      </section>
